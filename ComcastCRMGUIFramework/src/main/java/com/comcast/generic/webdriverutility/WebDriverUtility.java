...
public class WebDriverUtility extends JavaUtility 
{
	...
	public void takeScreenShot(WebDriver driver, String fileName) throws IOException
	{
		...
		//Destination File
		File destfile=new File("./AllScreenShots/"+fileName+".png");
	...
	public String takeScreenShotForReport(WebDriver driver, String testName) throws IOException {
		
		String path = "./AllScreenShots/"+testName+".png";
		TakesScreenshot ts =(TakesScreenshot)driver;
		//Temporary Location
		File scrfile=ts.getScreenshotAs(OutputType.FILE);
		//Destination File
